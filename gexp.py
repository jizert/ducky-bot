...
def storeGEXP():
    ...
    guildData = requests.get('https://api.hypixel.net/guild?key=' + apiKey + '&id=619fa16f8ea8c940a6e5bb71').json()
...
def getPlayerGEXPMessage(uuid):
    ...
    playerGEXPMessage = discord.Embed(title='[' + playerGEXP[4] + '] ' + name, url='https://plancke.io/hypixel/guild/player/jizert', description=playerGEXP[3],
                                      color=16755200)
    ...
    playerGEXPMessage.set_footer(text='Ducky Bot made by Jizert')
...
def getWeeklyGEXPTopMessage():
    ...
    weeklyGEXPTopMessage = discord.Embed(title='Ducky\'s Leaderboard', url='https://plancke.io/hypixel/guild/player/jizert',
                                         color=16755200)
    ...
    weeklyGEXPTopMessage.set_footer(text='Ducky Bot made by Jizert')
...
def getDailyGEXPTopMessage():
    ...
    dailyGEXPTopMessage = discord.Embed(title='Ducky\'s Leaderboard', url='https://plancke.io/hypixel/guild/player/jizert',
                                        color=16755200)
    ...
    dailyGEXPTopMessage.set_footer(text='Ducky Bot by Jizert')
